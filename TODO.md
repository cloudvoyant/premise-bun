...
- [ ] plugins
  ...
  - pi-todo?
  - pi-premise-bun -> ps:* skills wrapping mcps?

# Questions

- What is the point?
  - To hold us over until premise-bun is ready... which will allow moving major workflows out of brtille skills and ever-changing harnesses.
...
- The real options here are:
  ...
  - Build a lightweight set of skills around using existing pi plugins (pi subagents, pi bg, etc.) -> **THIS IS THE THING TO DO WITH PREMISE-BUN**
